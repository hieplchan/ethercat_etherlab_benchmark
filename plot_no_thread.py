...
################# CALCULATE RESULT #################
with open('histogram_no_thread.csv','r') as csvfile:
...
################# SAVE RESULT #################
result = open('output/no_thread/result.txt','w')
...
plt.title('Period Histogram - No Thread')
plt.legend()
plt.savefig('output/no_thread/his_period.jpg', transparent=False, bbox_inches='tight', pad_inches=0)
plt.show()
...
plt.ylabel('number of sample')
plt.title('Latency Histogram - No Thread')
plt.legend()
plt.savefig('output/no_thread/his_latency.jpg', transparent=False, bbox_inches='tight', pad_inches=0)
plt.show()
...
plt.ylabel('number of sample')
plt.title('Executive Histogram - No Thread')
plt.legend()
plt.savefig('output/no_thread/his_executive.jpg', transparent=False, bbox_inches='tight', pad_inches=0)
plt.show()

################# PLOT TIME #################
plt.plot(num,period,label='Period - No Thread')
plt.xlabel('sample - Max: ' + str(period_max) + ' - Avr: ' + str(period_avr) + ' - Standard Deviation: ' +str(period_std))
plt.ylabel('period [ns]')
plt.title('Period')
plt.legend()
plt.savefig('output/no_thread/plot_period.jpg', transparent=False, bbox_inches='tight', pad_inches=0)
plt.show()

plt.plot(num,latency,label='Latency - No Thread')
plt.xlabel('sample - Max: '+ str(latency_max) + ' - Avr: ' + str(latency_avr) + ' - Standard Deviation: ' +str(latency_std))
plt.ylabel('latency [ns]')
plt.title('Latency')
plt.legend()
plt.savefig('output/no_thread/plot_latency.jpg', transparent=False, bbox_inches='tight', pad_inches=0)
plt.show()

plt.plot(num,executive,label='Executive - No Thread')
...
plt.title('Executive')
plt.legend()
plt.savefig('output/no_thread/plot_executive.jpg', transparent=False, bbox_inches='tight', pad_inches=0)
plt.show()
